...
function layout(gridModel, axisModel, opt) {
  ...
  layout4.position = [axisDim === "y" ? posBound[idx[axisPosition]] : rectBound[0], axisDim === "x" ? posBound[idx[axisPosition]] : rectBound[3]];
  layout4.rotation = Math.PI / 2 * (axisDim === "x" ? 0 : 1);
  var dirMap = {
    top: -1,
    bottom: 1,
    left: -1,
  ...
  layout4.labelDirection = layout4.tickDirection = layout4.nameDirection = dirMap[rawAxisPosition];
  layout4.labelOffset = otherAxisOnZeroOf ? posBound[idx[rawAxisPosition]] - posBound[idx.onZero] : 0;
  ...
  layout4.labelRotate = axisPosition === "top" ? -labelRotate : labelRotate;
  layout4.z2 = 1;
  return layout4;
}
...
var CartesianAxisView = (
  ...
  (function(_super) {
    ...
    CartesianAxisView2.prototype.render = function(axisModel, ecModel, api, payload) {
      ...
      var layout4 = layout(gridModel, axisModel);
...
var BaseAxisPointer = (
  ...
  (function() {
    ...
    BaseAxisPointer2.prototype.createPointerEl = function(group, elOption, axisModel, axisPointerModel) {
      ...
      if (pointerOption) {
        var pointerEl = inner2(group).pointerEl = new graphic_exports[pointerOption.type](clone2(elOption.pointer));
        group.add(pointerEl);
      }
    };
    BaseAxisPointer2.prototype.createLabelEl = function(group, elOption, axisModel, axisPointerModel) {
      if (elOption.label) {
        var labelEl = inner2(group).labelEl = new Text_default(clone2(elOption.label));
        group.add(labelEl);
...
function register(key, api, handler) {
  ...
  var zr = api.getZr();
  inner3(zr).records || (inner3(zr).records = {});
  initGlobalListeners(zr, api);
  var record = inner3(zr).records[key] || (inner3(zr).records[key] = {});
  record.handler = handler;
}
function initGlobalListeners(zr, api) {
  if (inner3(zr).initialized) {
    return;
  }
  inner3(zr).initialized = true;
  ...
  function useHandler(eventType, cb) {
    zr.on(eventType, function(e) {
      ...
      each2(inner3(zr).records, function(record) {
...
function unregister(key, api) {
  ...
  var zr = api.getZr();
  var record = (inner3(zr).records || {})[key];
  if (record) {
    inner3(zr).records[key] = null;
  }
}
...
function dispatchHighDownActually(axesInfo, dispatchAction3, api) {
  ...
  var lastHighlights = inner4(zr)[highDownKey] || {};
  var newHighlights = inner4(zr)[highDownKey] = {};
  each(axesInfo, function(axisInfo, key) {
    var option = axisInfo.axisPointerModel.option;
...
var Radar = (
  ...
  (function() {
    ...
    Radar2.prototype.resize = function(radarModel, api) {
      ...
      this.cx = parsePercent2(center[0], viewWidth);
      this.cy = parsePercent2(center[1], viewHeight);
...
function resizeGeo(geoModel, api) {
  ...
  if (centerOption && sizeOption) {
    center = [parsePercent2(centerOption[0], viewWidth), parsePercent2(centerOption[1], viewHeight)];
...
var SingleAxis = (
  ...
  (function(_super) {
    ...
    function SingleAxis2(dim, scale2, coordExtent, axisType, position) {
      var _this = _super.call(this, dim, scale2, coordExtent) || this;
      _this.type = axisType || "value";
      _this.position = position || "bottom";
      return _this;
...
var Parallel = (
  ...
  (function() {
    ...
    Parallel2.prototype._init = function(parallelModel, ecModel, api) {
      ...
      each3(dimensions, function(dim, idx) {
    ...
    Parallel2.prototype._updateAxesFromSeries = function(parallelModel, ecModel) {
      ecModel.eachSeries(function(seriesModel) {
        ...
        var data = seriesModel.getData();
        each3(this.dimensions, function(dim) {
    ...
    Parallel2.prototype._makeLayoutInfo = function() {
      ...
      var xy = ["x", "y"];
      var wh = ["width", "height"];
      var layout4 = parallelModel.get("layout");
      var pixelDimIndex = layout4 === "horizontal" ? 0 : 1;
    ...
    Parallel2.prototype._layoutAxes = function() {
      ...
      each3(dimensions, function(dim, idx) {
        ...
        var position = [positionTable[layout4].x + rect.x, positionTable[layout4].y + rect.y];
        var rotation = rotationTable[layout4];
        var transform = create();
...
var AxisModel_default2 = ParallelAxisModel;
...
function install9(registers) {
  ...
  axisModelCreator(registers, "parallel", AxisModel_default2, defaultAxisOption);
  ...
  (function(_super) {
    ...
    CalendarView2.prototype._renderLines = function(calendarModel, rangeData, orient, group) {
      ...
      function addPoints(date2) {
        ...
        var points3 = self._getLinePointsOfOneWeek(calendarModel, date2, orient);
        self._tlpoints.push(points3[0]);
        self._blpoints.push(points3[points3.length - 1]);
        show && self._drawSplitline(points3, lineStyleModel, group);
      }
      show && this._drawSplitline(self._getEdgesPoints(self._tlpoints, lineWidth, orient), lineStyleModel, group);
      show && this._drawSplitline(self._getEdgesPoints(self._blpoints, lineWidth, orient), lineStyleModel, group);
    };
    CalendarView2.prototype._getEdgesPoints = function(points3, lineWidth, orient) {
      var rs = [points3[0].slice(), points3[points3.length - 1].slice()];
      var idx = orient === "horizontal" ? 0 : 1;
      rs[0][idx] = rs[0][idx] - lineWidth / 2;
      rs[1][idx] = rs[1][idx] + lineWidth / 2;
      return rs;
    };
    CalendarView2.prototype._drawSplitline = function(points3, lineStyle, group) {
    ...
    CalendarView2.prototype._getLinePointsOfOneWeek = function(calendarModel, date, orient) {
      ...
      for (var i = 0; i < 7; i++) {
        ...
        points3[2 * tmpD.day] = point.tl;
        points3[2 * tmpD.day + 1] = point[orient === "horizontal" ? "bl" : "tr"];
      }
      return points3;
    };
    ...
    CalendarView2.prototype._renderYearText = function(calendarModel, rangeData, orient, group) {
      ...
      var points3 = [this._tlpoints[this._tlpoints.length - 1], this._blpoints[0]];
      var xc = (points3[0][0] + points3[1][0]) / 2;
      var yc = (points3[0][1] + points3[1][1]) / 2;
      var idx = orient === "horizontal" ? 0 : 1;
      var posPoints = {
        top: [xc, points3[idx][1]],
        bottom: [xc, points3[1 - idx][1]],
        left: [points3[1 - idx][0], yc],
        right: [points3[idx][0], yc]
      };
  ...
  (function(_super) {
        ...
        if (el) {
          ...
          if (clipPathOption) {
            ...
            if (isMerge) {
              ...
              isInit = !oldClipPath || inner6(oldClipPath).type !== clipPathType;
    ...
    GraphicComponentView2.prototype._relocate = function(graphicModel, api) {
      ...
      for (var i = 0; i < elOptions.length; i++) {
        ...
        var elInner = inner6(el);
        var parentElInner = inner6(parentEl);
    ...
    GraphicComponentView2.prototype._clear = function() {
      ...
      elMap.each(function(el) {
        removeEl(el, inner6(el).option, elMap, _this._lastGraphicModel);
      });
      this._elMap = createHashMap();
    };
...
function removeEl(elExisting, elOption, elMap, graphicModel) {
  ...
  if (existElParent) {
    ...
    elMap.removeKey(inner6(elExisting).id);
  }
}
...
var AxisProxy = (
  ...
  (function() {
    ...
    AxisProxy2.prototype.calculateDataWindow = function(opt) {
      ...
      each4(["start", "end"], function(prop, idx) {
    ...
    AxisProxy2.prototype.filterData = function(dataZoomModel, api) {
      ...
      each4(seriesModels, function(seriesModel) {
...
function push(ecModel, newSnapshot) {
  ...
  each5(newSnapshot, function(batchItem, dataZoomId) {
...
function pop(ecModel) {
  ...
  var snapshot = {};
  each5(head, function(batchItem, dataZoomId) {
...
var DataZoomFeature = (
  ...
  (function(_super) {
    ...
    DataZoomFeature2.prototype._dispatchZoomAction = function(snapshot) {
      var batch = [];
      each6(snapshot, function(batchItem, dataZoomId) {
...
registerInternalOptionCreator("dataZoom", function(ecModel) {
  ...
  each6(finderResult.xAxisModels, function(axisModel) {
    return buildInternalOptions(axisModel, "xAxis", "xAxisIndex");
  });
  each6(finderResult.yAxisModels, function(axisModel) {
...
var VisualMapping = (
  ...
  (function() {
    ...
    VisualMapping2.retrieveVisuals = function(obj) {
      var ret = {};
      var hasVisual;
      obj && each7(VisualMapping2.visualHandlers, function(h, visualType) {
    ...
    VisualMapping2.prepareVisualTypes = function(visualTypes) {
      if (isArray(visualTypes)) {
        ...
        var types_1 = [];
        each7(visualTypes, function(item, type) {
          types_1.push(type);
        });
        visualTypes = types_1;
      } else {
...
function preprocessForSpecifiedCategory(thisOption) {
  ...
  each7(categories, function(cate, index) {
    categoryMap[cate] = index;
  });
  if (!isArray(visual)) {
    var visualArr_1 = [];
    if (isObject(visual)) {
      each7(visual, function(v, cate) {
...
function createVisualMappings(option, stateList, supplementVisualOption) {
  var visualMappings = {};
  each8(stateList, function(state) {
    var mappings = visualMappings[state] = createMappings();
    each8(option[state], function(visualData, visualType) {
...
var selector = {
  ...
  polygon: {
    ...
    rect: function(itemLayout, selectors, area) {
      var points3 = area.range;
      if (!itemLayout || points3.length <= 1) {
        return false;
      }
      var x = itemLayout.x;
      var y = itemLayout.y;
      ...
      var p = points3[0];
      if (contain(points3, x, y) || contain(points3, x + width, y) || contain(points3, x, y + height) || contain(points3, x + width, y + height) || BoundingRect_default.create(itemLayout).contain(p[0], p[1]) || linePolygonIntersect(x, y, x + width, y, points3) || linePolygonIntersect(x, y, x, y + height, points3) || linePolygonIntersect(x + width, y, x + width, y + height, points3) || linePolygonIntersect(x, y + height, x + width, y + height, points3)) {
        return true;
      }
    }
  }
...
var SliderTimelineView = (
  ...
  (function(_super) {
    ...
    SliderTimelineView2.prototype._createAxis = function(layoutInfo, timelineModel) {
      ...
      var scale2 = createScaleByModel2(timelineModel, axisType);
      ...
      var axis = new TimelineAxis_default("value", scale2, layoutInfo.axisExtent, axisType);
...
var MarkerModel = (
  ...
  (function(_super) {
    ...
    MarkerModel2.prototype._mergeOption = function(newOpt, ecModel, createdBySelf, isInit) {
      ...
      if (!createdBySelf) {
        ecModel.eachSeries(function(seriesModel) {
          ...
          var markerModel = inner8(seriesModel)[componentType];
          if (!markerOpt || !markerOpt.data) {
            inner8(seriesModel)[componentType] = null;
            return;
          }
          if (!markerModel) {
            if (isInit) {
          ...
          inner8(seriesModel)[componentType] = markerModel;
        }, this);
      }
    };
    ...
    MarkerModel2.getMarkerModelFromSeries = function(seriesModel, componentType) {
      return inner8(seriesModel)[componentType];
    };
...
var MarkerView = (
  ...
  (function(_super) {
    ...
    MarkerView2.prototype.render = function(markerModel, ecModel, api) {
      ...
      markerGroupMap.each(function(item) {
        !inner9(item).keep && _this.group.remove(item.group);
      });
    };
    MarkerView2.prototype.markKeep = function(drawGroup) {
      inner9(drawGroup).keep = true;
    };
    ...
    MarkLineView2.prototype.updateTransform = function(markLineModel, ecModel, api) {
      ecModel.eachSeries(function(seriesModel) {
        ...
        if (mlModel) {
          ...
          var fromData_1 = inner10(mlModel).from;
          var toData_1 = inner10(mlModel).to;
...
var MarkAreaView = (
  ...
  (function(_super) {
      ...
      ecModel.eachSeries(function(seriesModel) {
        ...
        if (maModel) {
          ...
          areaData_1.each(function(idx) {
            var points3 = map(dimPermutations, function(dim) {
              return getSingleMarkerEndPoint(areaData_1, idx, dim, seriesModel, api);
            });
            areaData_1.setItemLayout(idx, points3);
            var el = areaData_1.getItemGraphicEl(idx);
            el.setShape("points", points3);
          });
        }
      }, this);
    };
    MarkAreaView2.prototype.renderSeries = function(seriesModel, maModel, ecModel, api) {
      ...
      areaData.diff(inner11(polygonGroup).data).add(function(idx) {
        ...
        var polygon = inner11(polygonGroup).data.getItemGraphicEl(oldIdx);
        ...
        var polygon = inner11(polygonGroup).data.getItemGraphicEl(idx);
        polygonGroup.group.remove(polygon);
      }).execute();
      ...
      inner11(polygonGroup).data = areaData;
...
var LegendView = (
  ...
  (function(_super) {
    ...
    LegendView2.prototype.renderInner = function(itemAlign, legendModel, ecModel, api, selector2, orient, selectorPosition) {
      ...
      each9(legendModel.getData(), function(legendItemModel, dataIndex) {
    ...
    LegendView2.prototype._createSelector = function(selector2, legendModel, api, orient, selectorPosition) {
      ...
      each9(selector2, function createSelectorButton(selectorItem) {
...
function getLegendStyle(iconType, legendItemModel, lineVisualStyle, itemVisualStyle, drawType, isSelected, api) {
  function handleCommonProps(style, visualStyle) {
    ...
    each9(style, function(propVal, propName) {
...
function disposeCoordSysRecordIfNeeded(api, dataZoomModel) {
  var coordSysRecordMap = inner12(api).coordSysRecordMap;
    ...
    VisualMapModel2.prototype.completeVisualOption = function() {
      ...
      function completeInactive(base2, stateExist, stateAbsent) {
        ...
        if (optExist && !optAbsent) {
          ...
          each10(optExist, function(visualData, visualType) {
            if (!VisualMapping_default.isValidType(visualType)) {
              return;
            }
      ...
      function completeController(controller2) {
        ...
        each10(this.stateList, function(state) {
...
var ContinuousView = (
  ...
  (function(_super) {
    ...
    ContinuousView2.prototype._renderBar = function(targetGroup) {
      ...
      var textSize = mathMax3(textRect.width, textRect.height);
      if (useHandle) {
        shapes.handleThumbs = [];
        shapes.handleLabels = [];
    ...
    ContinuousView2.prototype._createIndicator = function(visualMapModel, mainGroup, itemSize, textSize, orient) {
      var scale2 = parsePercent(visualMapModel.get("indicatorSize"), itemSize[0]);
    ...
    ContinuousView2.prototype._enableHoverLinkToSeries = function() {
      ...
      this._shapes.mainGroup.on("mousemove", function(e) {
        ...
        if (!self._dragging) {
          ...
          pos[1] = mathMin3(mathMax3(0, pos[1]), itemSize[1]);
    ...
    ContinuousView2.prototype._doHoverLinkToSeries = function(cursorPos, hoverOnBar) {
      ...
      var sizeExtent = [0, itemSize[1]];
      var dataExtent = visualMapModel.getExtent();
      cursorPos = mathMin3(mathMax3(sizeExtent[0], cursorPos), sizeExtent[1]);
...
function createPolygon(points3, cursor, onDrift, onDragEnd) {
  ...
  function setDecal() {
    ...
    if (useDecal) {
      ...
      ecModel.eachSeries(function(seriesModel) {
        ...
        inner13(seriesModel).scope = decalScope;
      });
      ecModel.eachRawSeries(function(seriesModel) {
        if (ecModel.isSeriesFiltered(seriesModel)) {
          return;
        ...
        if (!seriesModel.isColorBySeries()) {
          ...
          var idxMap_1 = {};
          var decalScope_1 = inner13(seriesModel).scope;
          data.each(function(idx) {
...
export {
  ...
  install3 as AxisPointerComponent,
  ...
  install7 as GeoComponent,
  install11 as GraphicComponent,
  install4 as GridComponent,
  ...
  install9 as ParallelComponent,
  install5 as PolarComponent,
  install6 as RadarComponent,
