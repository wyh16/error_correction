...
2. **分批处理**：按每 2-3 页一批进行分组，**相邻批次不重叠**
   - 例如 5 页数据：第1批 page 0-1，第2批 page 2-3，第3批 page 4
   - 例如 6 页数据：第1批 page 0-1-2，第2批 page 3-4-5
   - **重要**：每一页只能出现在一个批次中，绝对不要重复处理同一页
